...
public class Util {
	 ...
	 * 
	 * This function takes any map and converts it into a Map that is
	 * sorted by the values. The order is predictable, as we are using
	 * LinkedHashMap for the ordering.
	 * 
	 * @param map Input map that should be sorted by value
